State  Activation ,   GoingToBed ,   Idle ,   Init ,   JustWokeUp ,   PIT ,   Reset ,   WaitUntilRelease  ;
...
Transition InitTransitions[] = {
    
    { &Reset, pred_button_released}  
...
State Init = { "Init", InitAction, InitTransitions, 1 };
